...
$(DEST_DIR)/main.o: src/main.cpp src/Application.hpp src/State.hpp \
 ...
 src/MainMenu.hpp src/MenuState.hpp src/LoadState.hpp src/MapLoader.hpp \
 src/Block.hpp src/GameState.hpp src/ResultState.hpp src/ExitState.hpp
$(DEST_DIR)/MainMenu.o: src/MainMenu.cpp src/MainMenu.hpp src/State.hpp \
 src/Application.hpp src/TextPrinter.hpp src/ScoreManager.hpp \
 src/GameObject.hpp src/Platform.hpp src/Ball.hpp src/Bonus.hpp \
 src/MenuState.hpp
$(DEST_DIR)/MapLoader.o: src/MapLoader.cpp src/MapLoader.hpp src/Block.hpp \
 src/GameObject.hpp src/State.hpp src/Application.hpp \
 src/TextPrinter.hpp src/ScoreManager.hpp src/Platform.hpp src/Ball.hpp \
 src/Bonus.hpp
...
$(DEST_DIR)/StartupState.o: src/StartupState.cpp src/StartupState.hpp src/State.hpp \
 src/Application.hpp src/TextPrinter.hpp src/ScoreManager.hpp \
 src/GameObject.hpp src/Platform.hpp src/Ball.hpp src/Bonus.hpp
$(DEST_DIR)/State.o: src/State.hpp src/Application.hpp \
 src/TextPrinter.hpp src/ScoreManager.hpp src/GameObject.hpp \
 src/Platform.hpp src/Ball.hpp src/Bonus.hpp
$(DEST_DIR)/StateManager.o: src/Application.cpp src/Application.hpp src/State.hpp \
 src/TextPrinter.hpp src/ScoreManager.hpp src/GameObject.hpp \
 src/Platform.hpp src/Ball.hpp src/Bonus.hpp
