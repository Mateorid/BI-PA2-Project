...
if(NOT SDL2_NET_INCLUDE_DIR AND SDL2NET_INCLUDE_DIR)
    set(SDL2_NET_INCLUDE_DIR ${SDL2NET_INCLUDE_DIR} CACHE PATH "directory cache entry initialized from old variable name")
endif()
...
if(NOT SDL2_NET_LIBRARY AND SDL2NET_LIBRARY)
    set(SDL2_NET_LIBRARY ${SDL2NET_LIBRARY} CACHE FILEPATH "file cache entry initialized from old variable name")
endif()
